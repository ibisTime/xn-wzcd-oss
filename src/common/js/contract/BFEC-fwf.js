...
class ExportImport extends React.Component {
  ...
  createData(wb, data) {
    ...
    ws['!rows'] = [
      ...
      ws['B28'].s = {font: {sz: 12}, alignment: {horizontal: 'left', vertical: 'center'}};
  ...
  // 最新分期申请
  createZxfqsq(wb) {
    var ws = this.getSheet(wb, 48, 8, '最新分期申请');
    ws['!merges'] = [{
      e: {c: 7, r: 10},
      s: {c: 3, r: 10}
    }, {
  ...
  // 资信-开发区版本
  createZxKfqbb(wb) {
    var ws = this.getSheet(wb, 48, 8, '资信-开发区版本');
    ws['!merges'] = [{
      e: {c: 4, r: 4},
      s: {c: 2, r: 4}
    }, {
  ...
  // 资信-开发区版本（配偶）
  createZxKfqbbPo(wb) {
    var ws = this.getSheet(wb, 48, 8, '资信-开发区版本（配偶）');
    ws['!merges'] = [{
      e: {c: 4, r: 4},
      s: {c: 2, r: 4}
    }, {
  ...
  // 资信-通用版最新
  createZxTybzx(wb) {
    var ws = this.getSheet(wb, 48, 8, '资信-通用版最新');
    ws['!merges'] = [{
      e: {c: 4, r: 6},
      s: {c: 2, r: 6}
    }, {
  ...
  // 资信-通用版最新(配偶)
  createZxTybzxPo(wb) {
    var ws = this.getSheet(wb, 48, 8, '资信-通用版最新(配偶)');
    ws['!merges'] = [{
      e: {c: 4, r: 6},
      s: {c: 2, r: 6}
    }, {
  ...
  // 资信-通用版最新(担保人)
  createZxTybzxDbr(wb) {
    var ws = this.getSheet(wb, 48, 8, '资信-通用版最新(担保人)');
    ws['!merges'] = [{
      e: {c: 4, r: 6},
      s: {c: 2, r: 6}
    }, {
  ...
  // 共同还款承诺书
  createGthkcns(wb) {
    var ws = this.getSheet(wb, 48, 8, '共同还款承诺书');
    ws['!merges'] = [{
      e: {c: 7, r: 1},
      s: {c: 4, r: 1}
    }, {
  ...
  // 中介合同
  createZjht(wb) {
    var ws = this.getSheet(wb, 48, 8, '中介合同');
    ws['!merges'] = [{
      e: {c: 2, r: 5},
      s: {c: 1, r: 5}
    }, {
  ...
  // 担保分期服务协议
  createDbfqfwxy(wb) {
    var ws = this.getSheet(wb, 48, 8, '担保分期服务协议');
    ws['!merges'] = [{
      e: {c: 5, r: 20},
      s: {c: 4, r: 20}
    }, {
  ...
  // 收妥2
  createSt2(wb) {
    var ws = this.getSheet(wb, 49, 8, '收妥2');
    ws['!merges'] = [{
      e: {c: 1, r: 48},
      s: {c: 0, r: 48}
    }];
  ...
  // 收妥3
  createSt3(wb) {
    var ws = this.getSheet(wb, 48, 8, '收妥3');
    ws['!merges'] = [{
      e: {c: 1, r: 44},
      s: {c: 0, r: 44}
    }];
  ...
  // 新合同1
  createXht1(wb) {
    var ws = this.getSheet(wb, 48, 8, '新合同1');
    ws['!merges'] = [{
      e: {c: 2, r: 22},
      s: {c: 1, r: 22}
    }, {
  ...
  // 新合同6
  createXht6(wb) {
    var ws = this.getSheet(wb, 48, 8, '新合同6');
    ws['!merges'] = [{
      e: {c: 7, r: 13},
      s: {c: 6, r: 13}
    }, {
  ...
  // 新合同11
  createXht11(wb) {
    var ws = this.getSheet(wb, 48, 9, '新合同11');
    ws['!merges'] = [{
      e: {c: 8, r: 42},
      s: {c: 7, r: 42}
    }, {
  ...
  // 新合同13
  createXht13(wb) {
    var ws = this.getSheet(wb, 48, 9, '新合同13');
    ws['!merges'] = [{
      e: {c: 3, r: 5},
      s: {c: 2, r: 5}
    }, {
  ...
  // 贷款确认书
  createDkqrs(wb) {
    var ws = this.getSheet(wb, 48, 9, '贷款确认书');
    ws['!merges'] = [{
      e: {c: 4, r: 7},
      s: {c: 3, r: 7}
    }, {
