...
class ExportImport extends React.Component {
  ...
  createData(wb, data) {
    ...
    ws['A48'].s = {fill: {bgColor: {rgb: '993366'}}};
    ws['A49'].s = {fill: {bgColor: {rgb: '993366'}}};
    ws['A51'].s = {font: {color: {rgb: 'FF0000'}}};
    ws['A60'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A61'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A62'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A63'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A64'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A65'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A66'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A67'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A69'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A70'].s = {fill: {bgColor: {rgb: 'CCFFFF'}}};
    ws['A71'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A72'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A74'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A82'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A83'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A84'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A85'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['A73'].s = {fill: {bgColor: {rgb: 'FFC7CE'}}};
    ws['A79'].s = {fill: {bgColor: {rgb: 'FF99CC'}}};
    ws['A80'].s = {fill: {bgColor: {rgb: 'FF99CC'}}};
    ws['A88'].s = {fill: {bgColor: {rgb: '92D050'}}};
    ws['A89'].s = {fill: {bgColor: {rgb: '92D050'}}};
    ws['A90'].s = {fill: {bgColor: {rgb: '92D050'}}};
    ws['A91'].s = {fill: {bgColor: {rgb: '92D050'}}};
    ws['B48'].s = {fill: {bgColor: {rgb: '993366'}}};
    ws['B49'].s = {fill: {bgColor: {rgb: '993366'}}};
    ws['B51'].s = {font: {color: {rgb: 'FF0000'}}};
    ws['B40'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
    ws['B12'].s = {fill: {bgColor: {rgb: 'FFFF00'}}};
  }
  // 征信1
  createZx1(wb) {
