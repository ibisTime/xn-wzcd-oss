...
import { setTableData, setPagination, setBtnList, setSearchParam, clearSearchParam, doFetching, cancelFetching, setSearchData } from '@redux/loan/advMoney';
import { listWrapper } from 'common/js/build-list';
import { showWarnMsg, showSucMsg, getRoleCode, dateTimeFormat, moneyUppercase, moneyFormat } from 'common/js/util';
        ...
        btnEvent: {
          apply: (selectedRowKeys, selectedRows) => {
            if (!selectedRowKeys.length) {
              ...
              showWarnMsg('请选择一条记录');
            } else if (selectedRows[0].curNodeCode !== '003_01' && selectedRows[0].curNodeCode !== '003_06' &&
              selectedRows[0].curNodeCode !== '004_01' && selectedRows[0].curNodeCode !== '004_07') {
