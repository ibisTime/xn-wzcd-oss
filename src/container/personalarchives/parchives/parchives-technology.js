...
import {
    ...
    setPageData,
    restore
} from '@redux/personalarchives/parchives-technology.js';
import {
    getQueryString,
    getUserId,
    showSucMsg
...
@CollapseWrapper(
    state => state.personalarchivesParchivesTechnology, {
        initStates,
        doFetching,
        cancelFetching,
        setSelectData,
...
class ParchivesTechnology extends React.Component {
    constructor(props) {
        super(props);
...
export default ParchivesTechnology;