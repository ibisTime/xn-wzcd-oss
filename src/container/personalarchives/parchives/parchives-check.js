...
import {
    ...
    setPageData,
    restore
} from '@redux/personalarchives/parchives-check.js';
import {
    getQueryString,
    getUserId,
    showSucMsg
...
@CollapseWrapper(
    state => state.personalarchivesParchivesCheck, {
        initStates,
        doFetching,
        cancelFetching,
        setSelectData,
...
class ParchivesCheck extends React.Component {
    constructor(props) {
        super(props);
