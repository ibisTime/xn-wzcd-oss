...
import {
    ...
    setPageData,
    restore
} from '@redux/postloantools/import-prepayment';
import {
  getQueryString,
  showSucMsg,
  getUserId
...
@DetailWrapper(
    state => state.postloantoolsImportPrepayment, {
        initStates,
        doFetching,
        cancelFetching,
        setSelectData,
...
class ImportPrepayment extends React.Component {
    constructor(props) {
        super(props);
...
export default ImportPrepayment;