...
class ExportImport extends React.Component {
  ...
  createData(wb, data) {
    ...
    ws['B23'].f = 'TEXT(D23,"0.00")&"/"&TEXT(D24,"0.00")';
  ...
  createTesqs(wb) {
    ...
    ws['D5'].s = ws['D6'].s = ws['D8'].s = ws['D10'].s = ws['D11'].s =
      ws['D12'] = ws['D16'].s = ws['D18'].s = ws['D19'].s = ws['D20'].s =
  ...
  createGhhtfm(wb) {
    ...
    ws['D22'].s = ws['D26'].s = {alignment: {horizontal: 'left', vertical: 'center'}};
  ...
  createD1(wb) {
    ...
    ws['A34'].f = '数据!B29';
    ws['A34'].s = {alignment: {horizontal: 'right', vertical: 'bottom'}};
    ws['C36'] = {v: '温州浩源控股有限公司', t: 's', w: '温州浩源控股有限公司'};
    ws['C36'].s = ws['G28'].s = {alignment: {horizontal: 'left', vertical: 'bottom'}};
    ws['D29'].f = '数据!B31';
    ws['D29'].s = ws['D31'].s = ws['E38'].s = {alignment: {horizontal: 'center', vertical: 'center'}};
    ws['D31'] = {v: '汽车', t: 's', w: '汽车'};
    ws['D32'].f = '数据!B26';
    ws['D32'].s = ws['D41'].s = ws['F36'].s = ws['G35'].s = {alignment: {horizontal: 'center', vertical: 'bottom'}};
    ws['D41'].f = '数据!B17';
    ws['E38'].f = '数据!B17';
  ...
  createD2(wb) {
    ...
    ws['C31'].s = ws['C33'].s = ws['C35'].s = {alignment: {horizontal: 'left', vertical: 'bottom'}};
  ...
  createD3x(wb) {
    ...
    ws['F3'] = {v: '叁拾陆', t: 's', f: '数据!B20', w: '叁拾陆'};
    ws['F3'].s = {font: {sz: 10}, alignment: {horizontal: 'center', vertical: 'center'}};
    ws['F16'].f = '数据!B22';
    ws['F3'].s = {font: {sz: 9}, alignment: {horizontal: 'right', vertical: 'center'}};
  }
  // 第4
  createD4(wb) {
