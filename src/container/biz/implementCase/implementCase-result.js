...
import {
    ...
    setPageData,
    restore
} from '@redux/biz/implementCase/implementCase-result';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@DetailWrapper(state => state.bizImplementCaseResult, {
    initStates,
    doFetching,
    cancelFetching,
    setSelectData,
...
class ImplementCaseResult extends React.Component {
    constructor(props) {
        super(props);
...
export default ImplementCaseResult;