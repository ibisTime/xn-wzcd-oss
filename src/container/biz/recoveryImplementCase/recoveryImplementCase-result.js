...
import {
    ...
    setPageData,
    restore
} from '@redux/biz/recoveryImplementCase/recoveryImplementCase-result';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@DetailWrapper(state => state.bizRecoveryImplementCaseResult, {
    initStates,
    doFetching,
    cancelFetching,
    setSelectData,
...
class RecoveryImplementCaseResult extends React.Component {
    constructor(props) {
        super(props);
...
export default RecoveryImplementCaseResult;