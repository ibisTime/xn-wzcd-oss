...
import {
    ...
    setPageData,
    restore
} from '@redux/biz/recoveryImplementCase/recoveryImplementCase-notice';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@DetailWrapper(state => state.bizRecoveryImplementCaseNotice, {
    initStates,
    doFetching,
    cancelFetching,
    setSelectData,
...
class RecoveryImplementCaseNotice extends React.Component {
    constructor(props) {
        super(props);
...
export default RecoveryImplementCaseNotice;