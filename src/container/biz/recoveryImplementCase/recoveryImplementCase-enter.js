...
import {
    ...
    setPageData,
    restore
} from '@redux/biz/recoveryImplementCase/recoveryImplementCase-enter';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@DetailWrapper(state => state.bizRecoveryImplementCaseEnter, {
    initStates,
    doFetching,
    cancelFetching,
    setSelectData,
...
class RecoveryImplementCaseEnter extends React.Component {
    constructor(props) {
        super(props);
...
export default RecoveryImplementCaseEnter;