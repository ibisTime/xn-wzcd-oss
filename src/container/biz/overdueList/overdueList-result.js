...
import {
    ...
    setPageData,
    restore
} from '@redux/biz/overdueList/overdueList-result';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@DetailWrapper(state => state.bizOverdueListResult, {
    initStates,
    doFetching,
    cancelFetching,
    setSelectData,
...
class OverdueListResult extends React.Component {
    constructor(props) {
        super(props);
...
export default OverdueListResult;